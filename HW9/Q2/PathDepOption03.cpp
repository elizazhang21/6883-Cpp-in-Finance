...
void GetZ(vector<double>& Z, SamplePath& S, double S0, double r, double sigma, double dt)
{
	int m = (int)S.size();
...
void Rescale(SamplePath& S, vector<double>& Z, double S0, double r, double sigma, double dt)
{
	int m = (int)S.size();
